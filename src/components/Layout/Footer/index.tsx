  ...
  return (
    <footer>
      <div className='container mx-auto max-w-[1272px] pt-20 pb-6 px-7'>
        <div className='mb-16 py-16 border-b border-black/10'>
          <div className='grid grid-cols-6 sm:grid-cols-12 md:gap-16 gap-12'>
            <div className='flex flex-col gap-6 md:col-span-5 sm:col-span-6 col-span-5'>
              ...
              <div>
                <p className='text-base font-normal text-black/60 leading-5'>
              ...
              <div
                ...
                <ul className='flex flex-col gap-3'>
                  {item.links?.map((linkitem, linkindex) => (
                    <li
                      key={linkindex}
                      className='text-base font-normal text-black/60 hover:text-black'>
            ...
            <div className='md:col-span-3 xxs:col-span-6 col-span-5'>
              ...
              <div className='text-base font-normal text-black/60 flex flex-col gap-3'>
                <p>
        ...
        <div>
          <p className='text-sm font-normal text-black/40 text-center'>
