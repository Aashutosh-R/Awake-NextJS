      ...
      <div className='grid grid-cols-11 gap-6'>
        <div className='flex flex-col xs:flex-row sm:flex-col gap-12 col-span-11 sm:col-span-5'>
          <div>
            ...
            <p className={`text-xm font-normal ${item.textLightColor}`}>
              {item.title}
            </p>
          </div>
          <div>
            <div className='flex items-baseline gap-1 mb-2'>
              <h3 className={`${item.textColor} text-5xl font-medium`}>
                ${item.amount}
              </h3>
              <p className={`text-base font-normal ${item.textLightColor}`}>
                /month
              </p>
            </div>
        ...
        <div className='col-span-11 sm:col-span-5'>
          <p className={`${item.textColor} text-base font-medium mb-4`}>
            Features
          </p>
